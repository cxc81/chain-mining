...
# 分别存储在变量：
#    last_version_number_major、last_version_number_minor、last_version_number_patch
...
scoreboard players operation last_version_number_patch chain_mining_variables = #temp chain_mining_variables
scoreboard players operation last_version_number_patch chain_mining_variables %= 16 chain_mining_constants
...
scoreboard players operation #temp chain_mining_variables /= 16 chain_mining_constants
scoreboard players operation last_version_number_major chain_mining_variables = #temp chain_mining_variables

execute store result storage chain_mining:data function_call.version_number_major int 1 run scoreboard players get last_version_number_major chain_mining_variables
...
execute store result storage chain_mining:data function_call.version_number_patch int 1 run scoreboard players get last_version_number_patch chain_mining_variables
