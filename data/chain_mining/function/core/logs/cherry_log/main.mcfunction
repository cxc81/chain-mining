...
function chain_mining:core/generic/add_feedback {score_holder: "num_logs_mined", name_key: "block.minecraft.cherry_log"}
function chain_mining:core/generic/add_feedback {score_holder: "num_leaves_mined", name_key: "block.minecraft.cherry_leaves"}
