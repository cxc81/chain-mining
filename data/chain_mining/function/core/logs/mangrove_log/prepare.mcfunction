...
execute if predicate chain_mining:player/mainhand/holding_axe at @e[type=minecraft:item,tag=!chain_mining_detected,tag=chain_mining_mangrove_selected,limit=1,sort=nearest] run function chain_mining:core/logs/mangrove_log/main
