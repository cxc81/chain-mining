# 此处仅在首个挖掘的方块是红树根而非红树原木时才会执行
scoreboard players set num_blocks_mined/log chain_mining_variables 0
scoreboard players set num_blocks_mined/leaves chain_mining_variables 0
scoreboard players set num_blocks_mined/mangrove_roots chain_mining_variables 1
