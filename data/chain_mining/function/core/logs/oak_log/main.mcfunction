...
scoreboard players set num_blocks_mined/flowering_azalea_leaves chain_mining_variables 0
...
function chain_mining:core/generic/add_actionbar_feedback {score_holder: "num_blocks_mined/log", name_key: "block.minecraft.oak_log"}
function chain_mining:core/generic/add_actionbar_feedback {score_holder: "num_blocks_mined/leaves", name_key: "block.minecraft.oak_leaves"}
function chain_mining:core/generic/add_actionbar_feedback {score_holder: "num_blocks_mined/azalea_leaves", name_key: "block.minecraft.azalea_leaves"}
function chain_mining:core/generic/add_actionbar_feedback {score_holder: "num_blocks_mined/flowering_azalea_leaves", name_key: "block.minecraft.flowering_azalea_leaves"}
