...
execute if score total_drop_count chain_mining_variables matches 2.. at @e[predicate=chain_mining:item/nether_wart,tag=!chain_mining_detected,limit=1,sort=nearest] run function chain_mining:core/soft_crops/nether_wart/main
