execute if score @s chain_mining_andesite matches 1.. run function chain_mining:core/rocks/andesite/prepare
execute if score @s chain_mining_diorite matches 1.. run function chain_mining:core/rocks/diorite/prepare
execute if score @s chain_mining_granite matches 1.. run function chain_mining:core/rocks/granite/prepare
execute if score @s chain_mining_tuff matches 1.. run function chain_mining:core/rocks/tuff/prepare
