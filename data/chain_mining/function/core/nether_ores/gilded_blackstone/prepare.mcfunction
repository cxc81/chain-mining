...
execute at @e[type=minecraft:item,tag=!chain_mining_detected,tag=chain_mining_gilded_blackstone_drop,limit=1,sort=nearest] run function chain_mining:core/nether_ores/gilded_blackstone/main
