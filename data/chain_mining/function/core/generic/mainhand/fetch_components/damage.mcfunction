...
execute if data storage chain_mining:data items.mainhand.components."minecraft:damage" run return run data get storage chain_mining:data items.mainhand.components."minecraft:damage"
execute if data storage chain_mining:data items.mainhand.components."!minecraft:damage" run return -1

execute if items entity @s weapon.mainhand #chain_mining:damagable run return 0
return -1
