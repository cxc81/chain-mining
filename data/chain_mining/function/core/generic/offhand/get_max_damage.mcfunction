...
# Tools
execute if items entity @s weapon.offhand #chain_mining:material/holdable/golden run return 32
execute if items entity @s weapon.offhand #chain_mining:material/holdable/wooden run return 59
execute if items entity @s weapon.offhand #chain_mining:material/holdable/stone run return 131
execute if items entity @s weapon.offhand #chain_mining:material/holdable/copper run return 190
execute if items entity @s weapon.offhand #chain_mining:material/holdable/iron run return 250
execute if items entity @s weapon.offhand #chain_mining:material/holdable/diamond run return 1561
execute if items entity @s weapon.offhand #chain_mining:material/holdable/netherite run return 2031
...
execute if items entity @s weapon.offhand #chain_mining:material/armor/copper_helmet run return 121
execute if items entity @s weapon.offhand #chain_mining:material/armor/copper_chestplate run return 176
execute if items entity @s weapon.offhand #chain_mining:material/armor/copper_leggings run return 165
execute if items entity @s weapon.offhand #chain_mining:material/armor/copper_boots run return 143
execute if items entity @s weapon.offhand #chain_mining:material/armor/iron_like_helmets run return 165
execute if items entity @s weapon.offhand #chain_mining:material/armor/iron_like_chestplates run return 240
execute if items entity @s weapon.offhand #chain_mining:material/armor/iron_like_leggings run return 225
execute if items entity @s weapon.offhand #chain_mining:material/armor/iron_like_boots run return 195
