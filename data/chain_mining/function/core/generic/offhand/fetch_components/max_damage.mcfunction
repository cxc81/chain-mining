...
execute if data storage chain_mining:data items.offhand.components."minecraft:max_damage" run return run data get storage chain_mining:data items.offhand.components."minecraft:max_damage"
execute if data storage chain_mining:data items.offhand.components."!minecraft:max_damage" run return 0

return run function chain_mining:core/generic/query_default_max_damage with storage chain_mining:data items.offhand
