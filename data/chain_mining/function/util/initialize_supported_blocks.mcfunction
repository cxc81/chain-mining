...
data modify storage chain_mining:data data.supported_blocks.soft_crops set value [\
    ...
    {translate: "block.minecraft.potatoes"}, \
    {translate: "block.minecraft.beetroots"}, \
    {translate: "block.minecraft.nether_wart"}, \
    {translate: "block.minecraft.sweet_berry_bush"}, \
    {translate: "block.minecraft.torchflower"}, \
    {translate: "block.minecraft.pitcher_crop"}, \
    {translate: "block.minecraft.sugar_cane"}, \
    {translate: "block.minecraft.cave_vines"}, \
    {translate: "block.minecraft.resin_clump"}, \
]
...
data modify storage chain_mining:data data.supported_blocks.hard_crops set value [\
    ...
    {translate: "block.minecraft.cocoa"}, \
