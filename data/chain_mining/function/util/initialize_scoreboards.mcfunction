...
scoreboard objectives add chain_mining_cherry_log minecraft.mined:minecraft.cherry_log {"translate": "chain_mining.scoreboard.cherry_log", "color": "gold", "fallback": "连锁采集：挖红树根"}
...
# 7. 设置与触发器
scoreboard objectives add chain_mining_setting_overworld_ores dummy {"translate": "chain_mining.scoreboard.setting.overworld_ores", "color": "gold", "fallback": "连锁采集：主世界矿石设置"}
scoreboard objectives add chain_mining_setting_nether_ores dummy {"translate": "chain_mining.scoreboard.setting.nether_ores", "color": "gold", "fallback": "连锁采集：下界矿石设置"}
...
scoreboard objectives add chain_mining_setting_rocks dummy {"translate": "chain_mining.scoreboard.setting.rocks", "color": "gold", "fallback": "连锁采集：岩石设置"}
scoreboard objectives add chain_mining_setting_crops_no_hardness dummy {"translate": "chain_mining.scoreboard.setting.crops_no_hardness", "color": "gold", "fallback": "连锁采集：无硬度作物设置"}
scoreboard objectives add chain_mining_setting_crops_with_hardness dummy {"translate": "chain_mining.scoreboard.setting.crops_with_hardness", "color": "gold", "fallback": "连锁采集：有硬度作物设置"}
