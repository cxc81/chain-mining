...
tellraw @s [{"translate": "chain_mining.message.automatically_downgrade.line2", "fallback": "上次安装的版本：%s", "color": "aqua", "with": [{"nbt": "data.last_data_version_str", "storage": "chain_mining:data", "interpret": true, "color": "green"}]}]
