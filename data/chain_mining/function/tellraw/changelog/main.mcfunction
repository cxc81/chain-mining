...
tellraw @s [{"text": " ", "color": "aqua"}, {"translate": "chain_mining.message.changelog.versions", "fallback": "数据包版本：%s  (Minecraft版本：%s)", "with": [{"nbt": "data.data_version_str", "storage": "chain_mining:data", "interpret": true, "color": "green"}, {"nbt": "data.supported_minecraft_versions_str", "storage": "chain_mining:data", "interpret": true, "color": "green"}]}]
