...
$execute if score @s chain_mining_setting_$(variable1) matches 0 run data modify storage chain_mining:data function_call.lines merge value {button_key1: "off", button_fallback1: "关", button_color1: "red", trigger_value1: $(index1)1, hover_key1: "enable", hover_fallback1: "开启"}
...
$execute if score @s chain_mining_setting_$(variable2) matches 0 run data modify storage chain_mining:data function_call.lines merge value {button_key2: "off", button_fallback2: "关", button_color2: "red", trigger_value2: $(index2)1, hover_key2: "enable", hover_fallback2: "开启"}
