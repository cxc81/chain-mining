...
execute if score holding_hoe_offhand chain_mining_variables matches 1 run function chain_mining:logs/oak_log/find_leaves
function chain_mining:logs/oak_log/find
