...
scoreboard objectives add mine_nether_quartz minecraft.mined:minecraft.nether_quartz_ore {"text":"\u6316\u4e0b\u754c\u77f3\u82f1\u77ff\u77f3"}
scoreboard objectives add mine_nether_gold minecraft.mined:minecraft.nether_gold_ore {"text":"\u6316\u4e0b\u754c\u91d1\u77ff\u77f3"}
...
scoreboard objectives add mine_sugar_cane minecraft.mined:minecraft.sugar_cane {"text":"\u6316\u7518\u8517"}
#6 - 农作物2(南瓜、西瓜、可可果)
...
scoreboard objectives add mine_cocoa minecraft.mined:minecraft.cocoa {"text":"\u6316\u53ef\u53ef\u679c"}
#7 - 其他
scoreboard objectives add mine_setting_ores dummy {"text":"\u519c\u4f5c\u7269\u8bbe\u7f6e"}
scoreboard objectives add mine_setting_logs dummy {"text":"\u539f\u6728/\u83cc\u67c4\u8bbe\u7f6e"}
scoreboard objectives add mine_setting_stones dummy {"text":"\u7c7b\u77f3\u5934\u8bbe\u7f6e"}
scoreboard objectives add mine_setting_glowstone dummy {"text":"\u8367\u77f3\u8bbe\u7f6e"}
scoreboard objectives add mine_setting_crops_1 dummy {"text":"\u519c\u4f5c\u72691\u8bbe\u7f6e"}
scoreboard objectives add mine_setting_crops_2 dummy {"text":"\u519c\u4f5c\u72692\u8bbe\u7f6e"}
