...
execute if predicate mine:mainhand/holding_axe at @e[type=minecraft:item,tag=!detected,tag=mine_mangrove_selected,limit=1,sort=nearest] run function mine:logs/mangrove_log/main
