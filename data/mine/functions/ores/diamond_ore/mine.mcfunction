...
execute if block ~ ~ ~ minecraft:diamond_ore run playsound minecraft:block.stone.break block @a
execute if block ~ ~ ~ minecraft:deepslate_diamond_ore run playsound minecraft:block.deepslate.break block @a
