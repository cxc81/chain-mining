...
execute if block ~ ~ ~ minecraft:coal_ore run playsound minecraft:block.stone.break block @a ~ ~ ~ 1 0.8
execute if block ~ ~ ~ minecraft:deepslate_coal_ore run playsound minecraft:block.deepslate.break block @a ~ ~ ~ 1 0.8
