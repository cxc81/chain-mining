...
execute if block ~ ~ ~ minecraft:lapis_ore run playsound minecraft:block.stone.break block @a
execute if block ~ ~ ~ minecraft:deepslate_lapis_ore run playsound minecraft:block.deepslate.break block @a
