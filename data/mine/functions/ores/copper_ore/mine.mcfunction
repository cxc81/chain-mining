...
execute if block ~ ~ ~ minecraft:copper_ore run playsound minecraft:block.stone.break block @a ~ ~ ~ 1 0.8
execute if block ~ ~ ~ minecraft:deepslate_copper_ore run playsound minecraft:block.deepslate.break block @a ~ ~ ~ 1 0.8
