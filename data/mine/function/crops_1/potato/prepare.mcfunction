...
scoreboard players set total_drop_count mine_variables 0
...
execute if score total_drop_count mine_variables matches 2.. at @e[type=minecraft:item,tag=!mine_detected,nbt={Item:{id:"minecraft:potato"}},limit=1,sort=nearest] run function mine:crops_1/potato/main
