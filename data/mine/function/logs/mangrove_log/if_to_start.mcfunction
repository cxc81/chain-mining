...
# 并为出现的掉落物添加标签
execute if score @s mine_mangrove_log matches 1.. run tag @e[type=minecraft:item,tag=!mine_detected,nbt={Item:{id:"minecraft:mangrove_log"}},limit=1,sort=nearest] add mine_mangrove_drop
