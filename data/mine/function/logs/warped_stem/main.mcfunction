...
execute store success score match_tool_offhand mine_variables if predicate mine:player/offhand/holding_hoe
execute if score match_tool_offhand mine_variables matches 1 run function mine:logs/warped_stem/find_wart
