...
scoreboard players operation last_version_number_minor mine_variables %= 16 Const
...
scoreboard players operation last_version_number_sub mine_variables %= 16 Const
scoreboard players operation temp mine_variables /= 16 Const
