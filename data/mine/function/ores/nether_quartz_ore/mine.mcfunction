...
# xp: 2-5
execute unless score silk_touch_level_mainhand mine_variables matches 1.. summon minecraft:experience_orb run function mine:ores/nether_quartz_ore/exp_orb
