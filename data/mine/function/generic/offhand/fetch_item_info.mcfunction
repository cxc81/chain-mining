...
# 目前使用副手信息的只有菌柄
# 判断副手物品是否是挖掘工具
execute store result score holding_tool_offhand mine_variables run function mine:generic/offhand/is_holding_tool
...
execute store result score damage_offhand mine_variables run function mine:generic/offhand/get_damage
...
execute store result storage mine:data function_call.offhand.unbreaking_level int 1 run scoreboard players get unbreaking_level_offhand mine_variables
