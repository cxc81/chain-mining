...
tellraw @s {"text":" 1. 数据包版本：v4.3.0  (Minecraft版本：1.21 - 1.21.2)","color":"aqua"}
tellraw @s ["",{"text":" 2. 支持采集所有矿石、原木、菌柄、","color":"aqua"},{"text":"类石头方块","color":"aqua","hoverEvent":{"action":"show_text","contents":{"text":"安山岩、闪长岩、花岗岩、凝灰岩、方解石、紫水晶块和岩浆块"}}},{"text":"、荧石和农作物；","color":"aqua"}]
